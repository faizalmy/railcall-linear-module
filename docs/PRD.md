...
A production-grade RailCall module (`agentstack-labs/linear`) providing comprehensive governed access to Linear's project management API. The module implements 45 commands across 10 functional categories, supports OAuth2 authentication, includes caching and webhook handlers, and ships with comprehensive test coverage and CI/CD automation.
...
|-----------|--------|--------|
| Command coverage | Full API surface | 45 commands across 10 categories |
...
#### FR-1: Command Categories (45 commands)
...
**Acceptance criteria:**
- Unit tests for all 45 commands (>80% coverage)
...
**Acceptance criteria:**
- API reference for all 45 commands
...
| Aug 13 | Publish v0.2.6 to marketplace |
