...
**Version:** 0.2.1  
**Status:** Planning — this document describes the target design, not all of which ships in 0.2.1  
...
What this document describes versus what version 0.2.1 actually ships:

| Area | Designed here | Shipped in 0.2.1 |
|------|---------------|------------------|
| 36 commands | ✅ | ✅ |
